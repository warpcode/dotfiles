...
[ -z "$DOTFILES_SILENT" ] && DOTFILES_SILENT="0"
[ -z "$DOTFILES_SKIP_CHSHELL" ] && DOTFILES_SKIP_CHSHELL="0"
[ -z "$DOTFILES_REPO_URL" ] && DOTFILES_REPO_URL="https://github.com/warpcode/dotfiles.git"
