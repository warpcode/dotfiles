...
## 8. PROJECT MANAGEMENT & TICKETS

- **Context-Free Execution**: When creating or updating GitHub issues, tasks, or tickets, the description MUST contain all necessary execution context. Do not assume the developer or LLM has access to previous conversation logs. Explicitly include:
  - Required skill formatting and guidelines to follow.
  - Any relevant decision matrices or logic flows agreed upon in planning.
  - Expected output formats or schemas.
  - Explicit file paths and dependency chains.
