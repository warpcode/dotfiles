...
### Context-Free Execution (AI & Human)
Tickets MUST contain all necessary execution context. Do not assume the developer or LLM has access to previous conversation logs or tacit project knowledge. Explicitly include:
