...
export HOMELAB_ANSIBLE_DIR="${HOMELAB_ANSIBLE_DIR:-$HOME/src/homelab-ansible}"
export HOMELAB_ANSIBLE_REPO="${HOMELAB_ANSIBLE_REPO:-git@github.com:warpcode/homelab-ansible.git}"
