---
name: secrets-vault-classifier
description: >
  Reference rules for classifying KeePass/KeePassXC vault entries (e.g. Accounts.kdbx)
  using a flat tag taxonomy and metadata conventions. Use when classifying KeePass
  credentials, tags, or metadata; deciding which type:, env:, proto:, hw:, org:, cat:,
  loc:, or asset: tags to apply; auditing existing tags; designing new entry templates;
  or resolving secret taxonomy questions.
---
