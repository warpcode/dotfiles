...
4. Read `@references/database-bottlenecks.md` for patterns.
...
1. Audit bundle sizes: Check for un-treeshaken dependencies, duplicate packages, or uncompressed static assets.
2. Inspect route-level and component-level code splitting: Verify heavy views and modals use dynamic `import()` / lazy loading.
3. Read `@references/frontend-performance.md`.
