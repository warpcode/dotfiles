...
description: >
  Convert HTML snippets, web pages, or API responses into clean Markdown,
  GFM tables, and Obsidian notes. Use when converting HTML to markdown,
  clipping web content, or cleaning HTML formatting.
---
