...
while [[ $# -gt 0 ]]; do
  case $1 in
    -h|--help)
      echo "Usage: ./update_issue.sh [OPTIONS]"
      echo ""
      echo "Update the title and body content of an existing GitHub issue."
      echo ""
      echo "Options:"
...
gh issue edit "$issue_number" --repo "$owner/$repo" --title "$title" --body "$body"
