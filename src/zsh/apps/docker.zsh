...
_installer_add_docker_repo() {
    ...
    case $os in
        ...
        fedora)
            ...
            # Install dnf-plugins-core if not installed
...
_events_add_hook "installer_pre_install_debian" "_installer_add_docker_repo"
_events_add_hook "installer_pre_install_fedora" "_installer_add_docker_repo"
