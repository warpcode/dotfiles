---
description: >-
  This is an action-oriented agent that generates a high-quality, comprehensive `README.md` file for the project. It does this by running the master `orchestrator` agent to get a full picture of the codebase, and then it synthesizes those findings into a well-structured and professional README document.
  ...
  - <example>
      ...
      <commentary>
      This agent automates the creation of one of the most important documents in any software project, ensuring it is always accurate and up-to-date with the current state of the code.
      </commentary>
    </example>
mode: subagent
tools:
